...
function createGlassPanel(type) {
    ...
    switch (type) {
        case 'temperado':
            glassMat = createGlassMaterial({
                ...
                roughness: 0.06,
                transmission: 0.92,
                thickness: CONFIG.glassThickness * 80,
                ior: CONFIG.glassIOR,
                envMapIntensity: 0.7,
                clearcoat: 0.15,
                ...
                attenuationColor: new THREE.Color(0x88ff88),
        ...
        case 'laminado':
            glassMat = createGlassMaterial({
                ...
                roughness: 0.05,
                transmission: 0.88,
                thickness: CONFIG.glassThickness * 120,
                ior: CONFIG.glassIOR,
                envMapIntensity: 0.6,
                transparent: true,
                opacity: 0.9,
                side: THREE.DoubleSide,
                attenuationColor: new THREE.Color(0x99ff99),
    ...
    // Aplicar envMap
    if (envMap && glassMat.envMap !== undefined) {
...
function createGlassBorder(type) {
    if (type === 'espelho') return;
    
    const borderThickness = 0.012;
    const borderDepth = CONFIG.glassThickness + 0.004;
    const borderColor = type === 'fantasia' ? 0x70a070 : 0x55aa55;
